...
class Nude(object):
    ...
    def _analyse_regions(self):
        ...
        if total_skin / self.total_pixels * 100 < 15:
            self.message = 'The biggest region contains less than 15 ({:.2f})'.format(
    ...
    def inspect(self):
        _image = '{}{}{}x{}'.format(self.image.filename, self.image.format, self.image.width, self.image.height)
