...
class SimpleLayer(object):
    ...
    def getBackgrond(self):
        return self.background

    def paint(self, painting):
        self.content = painting

    def fillBackground(self, backgroud):
...
if __name__ == '__main__':
    ...
    print('Original Backgrond:', dog_layer.getBackgrond())
    print('Original Painting:', dog_layer.getContent())

    # another_dog_layer = dog_layer.colne()
    another_dog_layer = dog_layer.deep_clone()
    another_dog_layer.setParent(128)
    print(another_dog_layer == dog_layer)
    print('Original Backgrond:', dog_layer.getBackgrond())
    print('Original Painting:', dog_layer.getContent())

    print('Copy Backgrond:', another_dog_layer.getBackgrond())
